...
#Esta es la función que regula el flujo del juego:

def flujo_juego(coor_y, coor_x,suma, acierto, jugador, tab_b_us,tab_i):
    ...
    if acierto:
        ...
        if jugador == "usuario":
            ...
            print("¡Vaya!, ¡el ordenador ha impactado en uno de tus barcos y vuelve a jugar!:\n", tab_b_us)
            suma = suma - 1
